    ...
    <section id="solution" className="relative py-16 lg:py-20 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="আপনার দুনিয়াবি দায়িত্ব আর আখিরাতের আকাঙ্ক্ষার সেতু বাঁধতে আমাদের মডিউল। প্রতিটি মডিউল থেকে একটি নির্দিষ্ট অংশ সরাসরি নেকির ঝুড়ি ফানেলে প্রবাহিত হয়—দুনিয়া থেকে আখিরাতে।"
        />
